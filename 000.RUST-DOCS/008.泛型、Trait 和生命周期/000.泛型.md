...
|拓展点|说明|备注|参考|
|-|-|-|-|
|- 默认泛型参数|- `pub struct Box<T: ?Sized,#[unstable(feature = "allocator_api", issue = "32838")] A: Allocator = Global,(Unique<T>, A);` <br/> - A 具有默认值: `= Global`（默认泛型参数）： 具体看源码注释 |-|-[`Box[T]`](../../library/alloc/src/boxed.rs)|
|-|-|-|-|
|-|-|-|-|
|-|-|-|-|
|-|-|-|-|